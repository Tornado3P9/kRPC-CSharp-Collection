...
internal class Program
{
    public static void Main(string[] args)
    {
        try
        {
            ...
            // Connect to KRPC
            Connection conn = new("Launch into orbit");
        ...
        foreach (var arg in args)
        {
            try {
                ...
                else if (arg.StartsWith("--auto_throttle="))
                {
                    ...
                    {
                        throw new ArgumentException("Invalid auto throttle bool value.");
                    }
                }
                else if (arg.StartsWith("--ag5="))
                {
                    ...
                    {
                        throw new ArgumentException("Invalid Action Group 5 bool value.");
                    }
                }
            }
    ...
    private static Tuple<Panel, Button, Stream<bool>> SetupUI(Connection conn, bool autoThrottle)
    {
